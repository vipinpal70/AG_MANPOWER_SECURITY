    ...
    <section id="training" ref={sectionRef} className="py-20">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="inline-block py-1 px-3 rounded-full bg-accent bg-opacity-10 dark:bg-opacity-20 text-white dark:text-[#1b22a7] text-sm font-medium mb-4">Training & Guidelines</span>
          ...
          <div data-scroll>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md">
                <h4 className="text-lg font-semibold text-primary dark:text-[#f2b63d] mb-4">Do's</h4>
              ...
              <div className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md">
                <h4 className="text-lg font-semibold text-primary dark:text-[#f2b63d] mb-4">Don'ts</h4>
                <ul className="space-y-3">
