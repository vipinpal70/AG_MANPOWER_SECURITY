    ...
    <section id="quality" ref={sectionRef} className="py-20 bg-gray-50 dark:bg-gray-800">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="inline-block py-1 px-3 rounded-full bg-primary bg-opacity-10 dark:bg-opacity-20 text-white dark:text-white text-sm font-medium mb-4">Quality Policy</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1" data-scroll>
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-bold font-heading text-primary dark:text-[#24b0cf] mb-3">Quality Management System</h3>
              ...
              <div>
                <h3 className="text-xl font-bold font-heading text-primary dark:dark:text-[#24b0cf] mb-3">PDCA Approach</h3>
                ...
                <div className="grid grid-cols-2 gap-4 mt-6">
                  {pdcaSteps.map((step, index) => (
                    <div key={index} className="bg-white dark:bg-gray-900 p-4 rounded-lg shadow-sm">
                      <h4 className="font-semibold text-primary dark:text-[#d89f2c] mb-2">{step.title}</h4>
              ...
              <div>
                <h3 className="text-xl font-bold font-heading text-primary dark:text-[#24b0cf] mb-3">Quality Control Measures</h3>
          ...
          <div className="order-1 lg:order-2" data-scroll>
            <div className="relative">
              ...
              <div ref={qualityCardRef} className="absolute -bottom-6 -right-6 bg-white dark:bg-gray-900 p-6 rounded-xl shadow-lg max-w-xs" id="quality-card">
                <h4 className="font-bold text-primary dark:text-[#e0c124] mb-2">Customer Satisfaction</h4>
